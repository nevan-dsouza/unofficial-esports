...
const RegisterPage = () => {
  ...
  const handleInvite = async (index) => {
    ...
    if (email) {
      ...
      // If yes, send an invite and mark the slot as pending
      // If no, create an invite entry in the database for the user to join

      // For demonstration, we'll just mark the slot as pending
